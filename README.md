...
* **[E1T4](/starter/E1T4.txt)** - Text file identifying 2 poor security practices with justification. 
...
- **E2T2_config.png** - Screenshot of AWS Config showing non-compliant rules.<br>
![](./starter/screenshot/E2T2_config.PNG)
- **E2T2_inspector.png** - Screenshot of AWS Inspector showing scan results.<br>
![](./starter/screenshot/E2T2_inspector.PNG)<br>
- **E2T2_securityhub.png** - Screenshot of AWS Security Hub showing compliance standards for CIS foundations.
![](./starter/screenshot/E2T2_securityhub.PNG)<br>
- **[E2T2](/starter/E2T2.txt)** - Provide recommendations on how to remediate the vulnerabilities.
...
**Deliverables:** 
- **E2T2_config.png** - Screenshot of AWS Config showing non-compliant rules.<br>
![](./starter/screenshot/E2T2_config.PNG)<br>
- **E2T2_inspector.png** - Screenshot of AWS Inspector showing scan results.<br>
![](./starter/screenshot/E2T2_inspector.PNG)<br>
- **E2T2_securityhub.png** - Screenshot of AWS Security Hub showing compliance standards for CIS foundations.<br>
![](./starter/screenshot/E2T2_securityhub.PNG)<br>
- **[E2T2](/starter/E2T2.txt)** - Provide recommendations on how to remediate the vulnerabilities.<br>
...
- **E3T1_guardduty.png** - Screenshot of Guard Duty findings specific to the Exercise 3, Task 1 attack.<br>
![](./starter/screenshot/E3T1_guardduty.PNG)<br>
- **[E3T1](/starter/E3T1.txt)** - Answer to the questions at the end of Exercise 3, Task 1.<br>
- **E3T2_s3breach.png** - Screenshot showing the resulting breach after the brute force attack.
![](./starter/screenshot/E3T2_s3breach.PNG)<br>
...
**Deliverables:**
- **E3T2_s3breach.png** - Screenshot showing the resulting breach after the brute force attack.<br>
![](./starter/screenshot/E3T2_s3breach.PNG)<br>
- _Optional_ **Task 3** - Screenshots showing attack attempts and monitoring or logs from the WAF showing blocked attempts.
...
- **[E4T1](/starter/E4T1.txt)** - Answer to the prompts in Exercise 4, Task 1.<br>
- **E4T2_sshbruteforce.png** - Screenshot of terminal window showing the brute force attack and the remediation.<br>
![](./starter/screenshot/E4T2_sshbruteforce.PNG)<br>
- **E4T2_networksg.png** - Screenshot of the security group change.<br>
![](./starter/screenshot/E4T2_networksg.PNG)<br>
...
![](./starter/screenshot/E4T3_inspector.PNG)<br>
- **[E4T4](/starter/E4T4.txt)** - Answers from prompts in Exercise 4, Task 4.
...
**Deliverables**:
- **DevSecOpsPipline.[ppt or png]** - Your updated pipeline.<br>
![](starter/screenshot/DevSecOpsPipline.PNG)
...
**Deliverables**:
- **[E5T2](/starter/E5T2.txt)** - Answer from prompts in Exercise 5, Task 2.
